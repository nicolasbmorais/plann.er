...
export function DestinationAndHeader() {
    ...
    const displayedDate = tripDetails
        ? format(tripDetails.starts_at, "d' de 'LLL").concat(' até ').concat(format(tripDetails.ends_at, "d' de 'LLL"))
        : null;
    ...
    return (
        <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
                ...
                {isChangeLocalModalOpen && <ChangeLocalAndDateModal closeChangeLocalAndDateModal={closeChangeLocalModal} />}
            </div>
        </div>
    )
}
