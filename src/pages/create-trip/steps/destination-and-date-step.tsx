    ...
    return (
        <div className="h-16  bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className='flex items-center gap-2 flex-1'>
                ...
                <input onChange={event => setDestination(event.target.value)} autoComplete='address-level2' disabled={isGuestsInputOpen} name='destiny' type="text" placeholder="Para onde você vai?" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1" />
            </div>
            ...
            {isDatePickerOpen && (
                <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
                    <div className='rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                        ...
                        <DayPicker mode="range" selected={eventDate} onSelect={setEventDates} />
                    </div>
                </div>
            )}
